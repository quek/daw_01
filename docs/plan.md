...
| 2026-05-08 | (this commit) | docs | [plan_audio_followup.md](plan_audio_followup.md) 新設。 Phase 2 完了後に残る audio clip 関連の polish / 機能追加を 4 PR (DRY 化 → multi-clip Undo 統合 → plugin-FX Bounce → Audio Editor event 編集) + 後回し 2 件 (bounce_cache migration / VOICEVOX ClipContent::Audio 統合) で計画 |
