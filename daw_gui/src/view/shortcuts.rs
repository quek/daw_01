...
pub static SHORTCUTS: &[ShortcutDef] = &[
    ...
    ShortcutDef { name: "daw.toggle_mute", keys: &["Q"], category: ShortcutCategory::Track, description: "選択/カーソル下のクリップ・ノート・プラグイン・オートメーションレーンをミュート (バイパス) 切替", hidden: false, forward_from_external_window: false, typing_only: false, repeatable: false },
    // ----- クリップ・ノート -----
