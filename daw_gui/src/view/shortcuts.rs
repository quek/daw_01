...
pub static SHORTCUTS: &[ShortcutDef] = &[
    ...
    ShortcutDef { name: "daw.toggle_mute", keys: &["Q"], category: ShortcutCategory::Track, description: "選択/カーソル下のクリップ・ノート・プラグイン・オートメーションレーンをミュート (バイパス) 切替。トラックヘッダ / ミキサーのストリップ上ではトラックの無効化", hidden: false, forward_from_external_window: false, typing_only: false, repeatable: false },
    // ----- クリップ・ノート -----
    ...
    ShortcutDef { name: "daw.split_clip_at_cursor", keys: &["E"], category: ShortcutCategory::ClipNote, description: "カーソル位置でクリップ / ノートを分割", hidden: false, forward_from_external_window: false, typing_only: false, repeatable: false },
    ShortcutDef { name: "daw.split_clip_at_cursor_no_snap", keys: &["Alt+E"], category: ShortcutCategory::ClipNote, description: "クリップ / ノートを分割 (スナップ無効)", hidden: false, forward_from_external_window: false, typing_only: false, repeatable: false },
    // r.md #132: 対象は E と同じ (ノート / クリップ / オーディオエディタの event)。
    ShortcutDef { name: "daw.split_at_grid", keys: &["Shift+E"], category: ShortcutCategory::ClipNote, description: "グリッド線ごとにクリップ / ノートを分割", hidden: false, forward_from_external_window: false, typing_only: false, repeatable: false },
    ShortcutDef { name: "daw.glue_selected_clips", keys: &["J"], category: ShortcutCategory::ClipNote, description: "範囲を 1 クリップに結合 (ピアノロールでは同じ音のノートを結合)", hidden: false, forward_from_external_window: false, typing_only: false, repeatable: false },
